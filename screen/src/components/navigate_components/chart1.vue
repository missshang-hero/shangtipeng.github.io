  ...
  <div>
    <div class="chart1_tittle">
      <div class="chart1_tittle1">
        <h3>累计发运率<img src="../../../static/img/excuse.png"></h3>
      </div>
      <div class="chart1_tittle2">
        <h3>有效发运率<img src="../../../static/img/excuse.png"></h3>
      </div>
    </div>
    <div class="cake">
      ...
      <div class="roll_per1">
        <img src="../../../static/img/rollpersent.png" alt="">
      </div>
...
<script>
  ...
  export default {
    methods:{
      init:function () {
        const container = this.$refs.chart1;

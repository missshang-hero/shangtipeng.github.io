...
<script>
  export default {
    methods:{
        ...
        var geoFloor = new THREE.PlaneBufferGeometry( 3200, 3200 );
        ...
        //earth
        //添加地球 d地球贴图1
          var geometry = new THREE.SphereGeometry(7.4, 80, 80);
          ...
          //d地球贴图2(球体上贴的地图)
          var geometry0 = new THREE.SphereGeometry(7.5, 80, 80);
          ...
          //添加地球  线1
            var geometry2 = new THREE.SphereGeometry(13, 80, 80);
            ...
            scene.add(earth2);
            //添加地球  线2
              var geometry3 = new THREE.SphereGeometry(13, 80, 80);
              ...
              scene.add(earth3);
              //添加地球  线3
                var geometry4 = new THREE.SphereGeometry(13, 80, 80);

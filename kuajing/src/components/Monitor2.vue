<template style="">
  ...
  <Layout :style="{height: '100%',padding:'0 10px'}">
    <!-- 最外层盒子 -->
    <div id="monitor2" class="">
      <div class="header">
        <!-- <h3><img src="../../static/img/bgtittle.png" alt=""></h3> -->
      </div>
      <div class="iconheader">
        <div class="">
          <img src="../../static/img/logo3.png" alt="" style="width:350px">
        </div>
      </div>
      <!-- 页面主体部分区块 -->
      <Row class="container">
        	<!-- 总收入部分  :class="{'divmodal11': maphide, 'divmodal1': mapshow,'divmodal111':mapthree}"-->
            <div class="divmodal box-bor divmodal1" style="height:966px;float:left;background-color: RGBA(2, 26, 55, .75);">
            <div class="left_header" style="display:flex;flex-direction:column;">
              <div class="earn_tittle">
                <p style="padding-left:5px;"><img class="imgh3" src="../../static/img/tittle_style.png" alt="" title="">总收入<span style="font-size:16px;color: rgb(17, 150, 186);display:inline-block;transform:scale(.8,.8);" ref="totalIncomeUnit">(元)</span>
                 <a>  <img class="imghover" src="../../static/img/excuse.png"></a>
                  <span style="position:absolute;right:40px;font-size:15px;color:rgb(17, 150, 186)">
                  ...
                  <div class="chart1 bg1">
                      <!--历史总收入图表height:441px;-->
                      <div  v-show="isNum!=0">
                          <div ref="chart1" style="height:436px;width:780px;" ></div>
                      </div>

                      <!--当日总收入图表height:441px;-->
                      <div class="today-tab" style="height:436px;" v-show="isNum==0">
                          <p>今日累计:</p>
                          <h2 id="orderinNum" class = "orderinNum" style="font-family: myFirstFont;font-size:180px;height:150px" :style="{color:todayColor}">{{totalData.length?totalData[0].left.today.todayFinal:'--'}}</h2>
                          <div>
                              <p style="padding:1px;border:1px solid #009CFF">上周同期：{{totalData.length?totalData[0].left.today.hisTodayFinal:'--'}}</p>
                              <p style="padding:1px;border:1px solid #009CFF">同比：
            ...
            <div class="earn_tittle">
              <p style="padding-left:5px;">
                <img class="imgh3" src="../../static/img/tittle_style.png" alt="" title="">产品收入<span style="font-size:16px;color: rgb(36, 216, 255);display:inline-block;transform:scale(.8,.8);">(万元)</span>
                <!-- 改 -->
            ...
            <div class="roll">
              <div class="cakes">
              	<div>
	                <h3 class="f20">电商小包</h3>
	                <p class="cakes_persent f18">完成比(%)</p>
        		</div>
          ...
          <!-- 进出口收入部分  :class="{'divmodal22': maphide, 'divmodal2': mapshow,'divmodal222':mapthree}"-->
          <div class="left_header divmodal2 box-bor" style="height:483px;background-color:RGBA(2, 26, 55, .75)">
            <div class="earn_tittle">
              <p style="padding-left: 5px;"><img class="imgh3" src="../../static/img/tittle_style.png" alt="" title="">进出口收入<span style="font-size:16px;color: rgb(17, 150, 186);display:inline-block;transform:scale(.8,.8);">(万元)</span>
                <a><img class="imghover" src="../../static/img/excuse.png"></a>
                <span style="position:absolute;right:40px;font-size:15px;color:rgb(17, 150, 186)">
                  <img style="position:absolute;width:24px;left:-10px" src="../../static/img/tittle_time.png" alt="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;数据时间:{{time.lastTim}}</span></p>
            </div>
            <div class="monthwcblabel" style="font-size: 16px;">时间进度(%)</div>
            <div class="timeblabel" style="font-size: 16px;">月完成比(%)</div>


            <div class="earn_in" style="width:780px">
                ...
                <div class="entryoutleftsty fx bg1">
                    ...
                    <ul class="fx fx-colu" style="flex-grow: 1;justify-content:space-between;">
                        <li class="c1" :class="{'redtxt':(totalData.length)&&(Number(totalData[0].left.excit.persent)<Number(totalData[0].left.excit.timePersent))?true:false}">
                            <span style="font-size: 34px;font-weight: bold;">{{totalData.length?Number(totalData[0].left.excit.final).toFixed(2) :'--'}}</span><br><span style="font-size: 16px;">月累计(万元)</span>
                        </li>
                        <li class="c2">
                            <span style="font-size: 34px;font-weight: bold;">{{totalData.length?Number(totalData[0].left.excit.flag).toFixed(2) :'--'}}</span><br><span style="font-size: 16px;">月目标(万元)</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="entryoutleftsty fx bg1">
                    ...
                    <ul class="fx fx-colu" style="flex-grow: 1;justify-content:space-between;">
                        <li class="c1" :class="{'redtxt':(totalData.length)&&(Number(totalData[0].left.impo.persent)<Number(totalData[0].left.impo.timePersent))?true:false}">
                            <span style="font-size: 34px;font-weight: bold;">{{totalData.length?Number(totalData[0].left.impo.final).toFixed(2) :'--'}}</span><br><span style="font-size: 16px;">月累计(万元)</span>
                        </li>
                        <li class="c2">
                            <span style="font-size: 34px;font-weight: bold;">{{totalData.length?Number(totalData[0].left.impo.flag).toFixed(2) :'--'}}</span><br><span style="font-size: 16px;">月目标(万元)</span>
                        </li>
                    </ul>
                </div>
                <div class="earnindivmbottomBgh">
        ...
        <div class="mask" v-show="currBollType" style="display:none;"></div>
          <!-- 地球部分 -->
          <div ref="wordmap" class="wordmap divmodal3" :class="{'wordmaphide': maphide, 'wordmap': mapshow,'wordmapshow':mapthree}" id="wordmap">
            <!-- <chart2></chart2> -->
            <Map style="height:3200px;margin-top:-875px;"></Map>
          </div>
          <!-- 地图部分 -->
          <div ref="wordmaptoo" class="wordmap22" style="padding:0 100px" :class="{'wordmapshow1': maphide, 'wordmap2': mapshow,'wordmaphide':mapthree}">
          ...
          <div class="changemap"><!-- :class="{'changemap2':isMap ,'changemap3':isEarth}"-->
            ...
            <a style="display:block;height:100%;text-align:center;">
              <img id="imgchange" @click="imgchange2(1)" src="../../static/img/map2.png" v-if="currBollType" alt="">
        ...
        <!-- 月累计收入完成比排名部分  :class="{'divmodal44': maphide, 'divmodal4': mapshow,'divmodal444':mapthree}"-->
        <div class="divmodal divmodal4 box-bor" style="height:966px;background-color: RGBA(2, 26, 55, .75);">
          <div class="earn_tittle">
            <p style="margin:0;padding-left: 10px;"><img class="imgh3" src="../../static/img/tittle_style.png" alt="" style="left:0" title="">月累计收入完成比排名(%)
              <a><img class="imghover" src="../../static/img/excuse.png"></a>
              <span style="position:absolute;right:50px;font-size:15px;color:rgb(17, 150, 186)">
                <img style="position:absolute;width:24px;left:-10px" src="../../static/img/tittle_time.png" alt="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;数据时间:{{time.lastTim}}</span></p>
              </div>
              <div ref="chartright1" class="chartright1">

              </div>
              <div class="left_header right_header" style="height:483px;">
              <div class="earn_tittle">
        ...
        <!-- 全国产品结构部分 -->
        <div class="left_header right_header divmodal divmodal5 box-bor" style="height:483px;background-color: RGBA(2, 26, 55, .75);">
              <div class="earn_tittle">
  ...
  export default {
    ...
    data(){
      return {
        ...
        totalData:[],//总数据
        isNum:0,//当日，当月，历史
        //当前显示地图类型(切换图标)，ture表示当前显示的是地球，false表示当前显示的时候地图
        currBollType:false,
    ...
    methods:{
      ...
      imgchange2(num){
        ...
        mychart(mychartData,num){
            ...
            for(var i in mychartData){
                ...
                month.push({value:mychartData[i].name,textStyle:{fontSize:16}})
            }
            let title;// 标题个数
            let name1,name2;
            let data1=[]
            ...
            if(num==1){ //当月
                ...
                for(var i in mychartData){
                    ...
                    //data1.push({value:mychartData[i].final,textStyle:{fontSize:16}})
                    //data2=data1
                    data2.push(mychartData[i].hisFinal);
                    //data2.push({value:mychartData[i].hisFinal,textStyle:{fontSize:16}})
                }
                console.log(data1);
            }else if(num==2){ //历史
                title=['完成值','目标值',]
            ...
            tooltip: {
              trigger: 'axis',
                ...
                extraCssText:'font-size:16px;background:url("static/img/yelog.png") no-repeat;background-size:100% 100%;background-position:center',
            ...
            function chartearn1(){
                ...
                let option = {
                    ...
                    tooltip: {
                        ...
                        // 改
                        return /*'事业部：<strong style="font-size:16px">'+text.name+'</strong><br>*/'目标值：'+'<strong style="font-size:16px">'+text.flag+'</strong>'+'万'+'</br>'+
                        '实际值：'+'<strong style="font-size:16px">'+text.final+'</strong>'+'万'+'</br>'+
                        '完成比：'+'<strong style="font-size:16px">'+text.value+'</strong>'+'%'
                            // if (prams[0].data === min) {
                            // } else {
                    ...
                    series: [{
                            ...
                            yAxisIndex: 0,
                            label:{
                            show:true,position:'top',fontSize:16,
                ...
                y=[
                    {
                        ...
                        symbol: that.chartearn2Name=='台湾'?"image://./static/img/symbol622.png":"image://./static/img/symbol62.png",
                        symbolSize: [30, 55],
                        "imgName":"台湾"
                    }, {
                        symbol: that.chartearn2Name=='韩国'?"image://./static/img/symbol722.png":"image://./static/img/symbol72.png",
                        symbolSize:[30, 55],
                        "imgName":"韩国"
                    }, {
            ...
            function chartearn2(){
                let option = {
                    ...
                    tooltip: {
                        ...
                        extraCssText:'background-color:RGBA(255, 216, 0, 1);',
                        formatter: function (params) {
                            return /*'事业部：<strong style="font-size:15px">'+params[1].data.name+'</strong><br> */'<span style="font-size:16px">目标值:</span> <strong style="font-size:16px">' + params[1].data.flag +'</strong><span style="font-size:16px">万</span><br/>'+ ' <span style="font-size:16px">实际值:</span> <strong style="font-size:16px">' + params[1].data.final+'</strong><span style="font-size:16px">万</span><br/>'+' <span style="font-size:16px">完成比: </span><strong style="font-size:16px">' + params[1].data.value +'</strong>%';
                        }
                        //   formatter:'{c}<span style="font-size: 10px">单</span>',
                    },
                    grid: {
                    ...
                    series: [{
                        ...
                        barCategoryGap: '25%',
                        label:{
                            show:true,position:'insideBottom',fontSize:16,
                            textStyle:{color:'#02E4FF'}
                        },
                    ...
                    tooltip: {
                        ...
                        formatter: function (params) {
                            return  params.name+':<strong>'+ params.percent + '%</strong><br/>'
                                    + '货运数量：<strong>' + value[params.dataIndex].cargo + '万</strong><br/>'
                        ...
                        [{
                                ...
                                label:{
                                    normal: {
                                        ...
                                        rich: {
                                            b: {
                                                fontSize: 20,color:'#00F1FF',align: 'right'
                                            },
                                            d: {
                                                fontSize: 18,align: 'right'
                                            },
                                            c: {
                                                fontSize: 28,color:'#00F1FF',align: 'left'
                                            },
                                            e:{fontSize:18}
                                        }
                                    }
                            ...
                            },
                            {
                                ...
                                label:{
                                    normal: {
                                        ...
                                        rich: {
                                            b: {
                                                fontSize: 20,color:'#00F1FF',align: 'left'
                                            },
                                            d: {
                                                fontSize: 18,align: 'right'
                                            },
      ...
      init:function (axiosData) {
        ...
        $('.text').css({ "left": Number(this.time_Persent) +'%' });
          ...
          let option = {
              title:{
                  ...
                  textStyle: {
                      ...
                      fontWeight:700,
                      fontSize: 25,
                      textShadowBlur: 0,textShadowColor: 'RGBA(0, 144, 255, 1)'
                  }
              },
              backgroundColor: '',
            ...
            */
            ...
            let regionsData = (()=>{
            	...
            	let result = allRegion.map((item,ind)=>{
                    ...
                    if(item === '中国')obj.label = {show:true,color:'white',fontSize:20};
                    return obj;
            	});
            	return result;
            })();
            ...
            let option= ({
                ...
                tooltip: {
                      ...
                      extraCssText:'font-size:16px;background:url("static/img/maplog.png") no-repeat;background-size:100% 100%;background-position:center',
                    formatter: function(params) {
                      // console.log(params);
                        var text;
                        if (params.data.item) {
                           text = '<p style = "font-size:20px;text-align:center;line-height:35px;">'+params.name+'</p>'+
                                 '<p style = "font-size:16px;text-align:center;line-height:28px;">'+'完成值 '+'<strong style = "font-size:17px;color:RGBA(114, 233, 255, 1)">'+params.data.item.final+'</strong>'+' &nbsp;&nbsp;<span style="font-size:16px;">目标值</span> '+'<strong style = "font-size:17px;color:RGBA(114, 233, 255, 1)">'+params.data.item.flag+'</strong>'+' &nbsp;&nbsp;<span style="font-size:16px;>完成比</span> '+'<strong style = "font-size:17px;color:RGBA(114, 233, 255, 1)">'+params.data.item.persent+'</strong>'+'%'+'</p>'+
                                 '<div style="display:flex">'+
                                      '<div>'+
                                          '<p style="font-size:16px;">指标 </p>'+
                                          '<p style="line-height:30px">完成值 </p>'+
                                          '<p style="line-height:30px">目标值 </p>'+
                                          '<p style="line-height:30px">完成比 </p>'+
                                      '</div>'+
                                      '<div style="padding-left:15px;">'+
                                          '<p style="font-size:16px;">'+'电商小包 '+'</p>'+
                                      ...
                                      '<div style:"padding:12px">'+
                                          '<p style="padding-left:15px;font-size:16px">'+'国际快递 '+'</p>'+
                                      ...
                                      '</div>'+
                                      '<div>'+
                                          '<p style="padding-left:15px;font-size:16px">'+'FBA '+'</p>'+
                                      ...
                                      '</div>'+
                                      '<div>'+
                                          '<p style="padding-left:15px;font-size:16px">'+'联运 '+'</p>'+
    ...
    computed:{
        todayColor:function(){
            try{
              ...
              if(Number(curr) - Number(last)<0)return '#EF2888';
              else return '';
            }catch(err){
              return '';
            }
...
<style scoped>
  ...
  .earnindiv3 p{
    ...
    .earnindivmbottomBg{
      ...
      -webkit-animation: earnindivmbottomMove 20s linear infinite;
      animation: earnindivmbottomMove 20s linear infinite;
      background-position: 647% 60%;
  ...
  @keyframes wordctrl{
    ...
    @keyframes wordshowctrl{
      ...
      .divmodal11{
        ...
        height: 42vh;
        z-index: 99;
        animation: divmodal111 3s linear 1;
      }
      @keyframes divmodal111{
          0% {
            left: 35px;
            top: 2%;/*4vh;*/
            z-index: 66;
      ...
      .today-tab>p:first-child,.today-tab>div{height:16px;font-size:16px;color:#24D8FF;}
      ...
      .countrywide{
          ...
          width:93px;height:35px;line-height:33px;
      ...
      .goods_ddetail>p>span:last-child{
          padding-top:8px;
      }
</style>
